...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import FMM3D_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("62c264cc-5bfb-59d7-84eb-c0e4dde7f66b"))
platforms = [Pkg.Artifacts.unpack_platform(e, "FMM3D", artifacts_toml) for e in artifacts["FMM3D"]]
...
if best_platform === nothing
    @debug("Unable to load FMM3D; unsupported platform $(triplet(platform_key_abi()))")
else
